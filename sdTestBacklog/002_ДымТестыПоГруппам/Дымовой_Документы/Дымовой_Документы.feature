...
Сценарий: Открытие формы списка "СД_ПоверкаСчетчиков" 
	...
	Дано Я открываю основную форму списка документа "СД_ПоверкаСчетчиков"
	Если появилось предупреждение тогда
		Тогда я вызываю исключение "Не удалось открыть форму документа СД_ПоверкаСчетчиков"
	И Я закрываю текущее окно

Сценарий: Открытие формы объкта "СД_ПоверкаСчетчиков"

	Дано Я открываю основную форму документа "СД_ПоверкаСчетчиков"
	Если появилось предупреждение тогда
		Тогда я вызываю исключение "Не удалось открыть форму документа СД_ПоверкаСчетчиков"
	И Я закрываю текущее окно

	
Сценарий: Открытие формы списка "СД_МаршрутныйЛист" 

	Дано Я открываю основную форму списка документа "СД_МаршрутныйЛист"
	Если появилось предупреждение тогда
		Тогда я вызываю исключение "Не удалось открыть форму документа СД_МаршрутныйЛист"
	И Я закрываю текущее окно

Сценарий: Открытие формы объкта "СД_МаршрутныйЛист"

	Дано Я открываю основную форму документа "СД_МаршрутныйЛист"
	Если появилось предупреждение тогда
		Тогда я вызываю исключение "Не удалось открыть форму документа СД_МаршрутныйЛист"
	И Я закрываю текущее окно

	
Сценарий: Открытие формы списка "СД_ИзменениеСтатусаОборудования" 

	Дано Я открываю основную форму списка документа "СД_ИзменениеСтатусаОборудования"
	Если появилось предупреждение тогда
		Тогда я вызываю исключение "Не удалось открыть форму документа СД_ИзменениеСтатусаОборудования"
	И Я закрываю текущее окно

Сценарий: Открытие формы объкта "СД_ИзменениеСтатусаОборудования"

	Дано Я открываю основную форму документа "СД_ИзменениеСтатусаОборудования"
	Если появилось предупреждение тогда
		Тогда я вызываю исключение "Не удалось открыть форму документа СД_ИзменениеСтатусаОборудования"
	И Я закрываю текущее окно

	
Сценарий: Открытие формы списка "СД_СчетНаОплату" 

	Дано Я открываю основную форму списка документа "СД_СчетНаОплату"
	Если появилось предупреждение тогда
		Тогда я вызываю исключение "Не удалось открыть форму документа СД_СчетНаОплату"
	И Я закрываю текущее окно

Сценарий: Открытие формы объкта "СД_СчетНаОплату"

	Дано Я открываю основную форму документа "СД_СчетНаОплату"
	Если появилось предупреждение тогда
		Тогда я вызываю исключение "Не удалось открыть форму документа СД_СчетНаОплату"
	И Я закрываю текущее окно

	
Сценарий: Открытие формы списка "СД_ДатаОбходаОО" 

	Дано Я открываю основную форму списка документа "СД_ДатаОбходаОО"
	Если появилось предупреждение тогда
		Тогда я вызываю исключение "Не удалось открыть форму документа СД_ДатаОбходаОО"
	И Я закрываю текущее окно

Сценарий: Открытие формы объкта "СД_ДатаОбходаОО"

	Дано Я открываю основную форму документа "СД_ДатаОбходаОО"
	Если появилось предупреждение тогда
		Тогда я вызываю исключение "Не удалось открыть форму документа СД_ДатаОбходаОО"
	И Я закрываю текущее окно

	
Сценарий: Открытие формы списка "СД_ОперативныйПлан" 

	Дано Я открываю основную форму списка документа "СД_ОперативныйПлан"
	Если появилось предупреждение тогда
		Тогда я вызываю исключение "Не удалось открыть форму документа СД_ОперативныйПлан"
	И Я закрываю текущее окно

Сценарий: Открытие формы объкта "СД_ОперативныйПлан"

	Дано Я открываю основную форму документа "СД_ОперативныйПлан"
	Если появилось предупреждение тогда
		Тогда я вызываю исключение "Не удалось открыть форму документа СД_ОперативныйПлан"
	И Я закрываю текущее окно

	
Сценарий: Открытие формы списка "СД_КорректировкаГрафикаОбслуживания" 

	Дано Я открываю основную форму списка документа "СД_КорректировкаГрафикаОбслуживания"
	Если появилось предупреждение тогда
		Тогда я вызываю исключение "Не удалось открыть форму документа СД_КорректировкаГрафикаОбслуживания"
	И Я закрываю текущее окно

Сценарий: Открытие формы объкта "СД_КорректировкаГрафикаОбслуживания"

	Дано Я открываю основную форму документа "СД_КорректировкаГрафикаОбслуживания"
	Если появилось предупреждение тогда
		Тогда я вызываю исключение "Не удалось открыть форму документа СД_КорректировкаГрафикаОбслуживания"
	И Я закрываю текущее окно
